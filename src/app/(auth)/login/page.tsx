...
export default function LoginPage() {
    ...
    // ── Per-provider loading state for social buttons
    ...
    const handleSocialLogin = async (provider: 'google' | 'facebook' | 'apple') => {
        // Apple: not yet configured — show message
        if (provider === 'apple') {
        ...
        try {
            ...
            // Note: signIn with OAuth redirects automatically — no code runs after this line
        } catch {
        ...
        <div className="min-h-screen flex w-full font-sans text-[#304250] bg-[#f8fafc] items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1.5">
                            ...
                            <Link href="/forgot-password" className="text-[13px] font-bold text-[#EEBE1C] hover:opacity-80 transition-opacity">
                                Forgot password?
                            </Link>
                        </div>
                ...
                <p className="mt-8 text-center text-sm font-medium text-[#304250]/60">
                    ...
                    <Link href="/signup" className="text-[#20A46B] hover:opacity-80 font-bold transition-opacity">
                        Sign up for free
                    </Link>
                </p>
            </motion.div>
